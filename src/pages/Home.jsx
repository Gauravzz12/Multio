...
function Home() {
  const textGroups = [
    [
      ...
      { text: "Multio", color: "text-[#f508ff]" },
    ],
    [
      { text: "Your", color: "text-white" },
      { text: "Multiplayer", color: "text-[#f508ff]" },
    ],
    [
      { text: "Gaming", color: "text-[#f508ff]" },
  ...
  return (
    <main className=" m-0  bg-black text-white font-bold flex flex-col scroll-smooth ">
      ...
      <section className="Features w-screen pl-32 flex justify-between  pt-12 pr-12 bg-[#09012a]">
        <div className="flex flex-col mt-8 items-center">
          <div>
            <p className="text-[#f508ff] text-6xl font-serif">Features</p>
            <hr className="bg-[#f508ff] w-16 h-1 mb-4" />
            <p className="text-1xl font-serif">
              What You Will{" "}
              <span className="text-[#f508ff] text-3xl font-serif ">
                Experience
              </span>{" "}
            </p>
          </div>
      ...
      <section className="Popular w-screen pl-32 flex justify-between items-center pt-12 pr-12 bg-gradient-to-r from-[#020530] to-[#13063e]">
        <div className="flex flex-col mt-8 items-center">
          <div>
            <p className="text-[#f508ff] text-5xl font-serif mb-2 ">Popular</p>
            <hr className="bg-[#f508ff] w-16 h-1 mb-4" />
            <p className="text-[#f508ff] text-5xl font-serif mb-2 ml-7 ">
              Games
            </p>
