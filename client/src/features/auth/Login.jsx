...
export const Login = () => {
  ...
  const handleGoogleLogin = () => {
    window.location.href = import.meta.env.MODE === "development" ? "http://localhost:5000/auth/google" : "https://multio.netlify.app/auth/google";
  };

  const handleGithubLogin = () => {
    window.location.href = import.meta.env.MODE === "development" ? "http://localhost:5000/auth/github" : "https://multio.netlify.app/auth/github";
  };
