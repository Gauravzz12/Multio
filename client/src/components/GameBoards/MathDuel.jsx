  ...
  useEffect(() => {
    const newSocket = io(
      import.meta.env.MODE === "development"
        ? "http://localhost:5000/mathduel"
        : "https://multio-backend.up.railway.app/mathduel"
    );
    setSocket(newSocket);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
      <div className="absolute inset-0 opacity-30">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-violet-500 rounded-full mix-blend-multiply filter blur-xl animate-pulse"></div>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen p-4">
        ...
        <div className="text-center mb-12">
          <h1 className="text-6xl md:text-8xl font-bold mb-4 bg-gradient-to-r from-violet-400 via-purple-400 to-indigo-400 bg-clip-text text-transparent animate-pulse">
            MATH DUEL
          </h1>
        ...
        <div className="glass backdrop-blur-xl border border-white/20 rounded-3xl p-8 text-center">
          ...
          <p className="text-xl text-slate-300 mb-6">
            Math Duel is coming soon! Test your mathematical skills in fast-paced calculation battles.
          </p>
