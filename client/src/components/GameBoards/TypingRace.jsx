    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen p-4">
        ...
        <div className="text-center mb-12">
          <h1 className="text-6xl md:text-8xl font-bold mb-4 bg-gradient-to-r from-emerald-400 via-teal-400 to-cyan-400 bg-clip-text text-transparent animate-pulse">
            TYPING RACE
          </h1>
        ...
        <div className="glass backdrop-blur-xl border border-white/20 rounded-3xl p-8 text-center">
          ...
          <p className="text-xl text-slate-300 mb-6">
            Typing Race is coming soon! Test your typing speed and accuracy against other players.
          </p>
